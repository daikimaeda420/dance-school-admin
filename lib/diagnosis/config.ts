...
export type DiagnosisQuestionOption = {
  id: string; // 例: "1-1"
  label: string; // 表示テキスト
  tag?: string; // 判定用タグ（Q1〜Q4で使用）
  messageKey?: ConcernMessageKey; // Q5専用
};
...
export type DiagnosisQuestion = {
  ...
  title: string;
  description?: string;
  key: "level" | "age" | "genre" | "teacher" | "concern";
...
export const QUESTIONS: DiagnosisQuestion[] = [
  ...
  },
  {
    ...
    key: "age",
    options: [
      { id: "2-1", label: "未就学児（3歳〜6歳くらい）", tag: "Age_Kids" },
      { id: "2-2", label: "小学生（キッズ）", tag: "Age_Elementary" },
      { id: "2-3", label: "中学生・高校生", tag: "Age_Teen" },
      { id: "2-4", label: "大学生・専門学生", tag: "Age_Student" },
      {
        id: "2-5",
        label: "社会人（お仕事をしている方）",
        tag: "Age_Adult_Work",
  ...
  },
  {
    ...
    key: "genre",
    options: [
      { id: "3-1", label: "K-POP・流行りの曲", tag: "Genre_KPOP" },
      { id: "3-2", label: "重低音の効いたカッコいい洋楽", tag: "Genre_HIPHOP" },
      { id: "3-3", label: "オシャレでゆったりした曲", tag: "Genre_JAZZ" },
      { id: "3-4", label: "とにかく明るく楽しい曲", tag: "Genre_ThemePark" },
      { id: "3-5", label: "まだ迷っている・色々見てみたい", tag: "Genre_All" },
    ],
  },
  {
    id: "Q4",
