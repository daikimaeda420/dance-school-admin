...
export default function ClassIntroduction({ courseName, description }: Props) {
  ...
  return (
    <div className="rounded-[32px] border border-[#EFE7DB] bg-white px-5 py-8 text-center shadow-sm">
      {/* 見出し */}
      ...
      <div className="relative mt-7 inline-block">
        <div className="relative z-10 rounded-full border border-[#EFE7DB] bg-white px-6 py-2 shadow-sm">
          <span className="text-[13px] font-bold text-[#7A4C1F]">
            周りの9割が未経験スタート
          </span>
        </div>
        <div className="absolute left-1/2 top-full -mt-2.5 h-4 w-4 -translate-x-1/2 rotate-45 border-b border-r border-[#EFE7DB] bg-white" />
      </div>
